...
exports.getPeriodoQuery = exports.getTotalQuery = exports.getSemestreQuery = exports.getEstatusQuery = exports.queries = void 0;
exports.queries = {
    getMatriculaCore: `
...
const getEstatusQuery = (unidad, carrera, ids) => {
    let query = ``;
    if (carrera) {
        query += `
...
exports.getEstatusQuery = getEstatusQuery;
const getSemestreQuery = (unidad, carreras, ids) => {
    let query = `SELECT `;
    if (unidad)
...
exports.getSemestreQuery = getSemestreQuery;
const getTotalQuery = (ids, unidad) => {
...
exports.getTotalQuery = getTotalQuery;
const getPeriodoQuery = (ids, unidad) => {
...
exports.getPeriodoQuery = getPeriodoQuery;
