...
exports.connectDB = exports.coreBackupDB = exports.dataDB = exports.coreDB = void 0;
...
const coreBackupDB = new sequelize_1.Sequelize(process.env.COREBACKUP_DB_NAME, process.env.DB_USER, process.env.DB_PASSWORD, {
    host: process.env.DB_HOST,
    dialect: 'mariadb',
    logging: false,
    dialectOptions: {
...
exports.coreBackupDB = coreBackupDB;
...
const connectDB = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield coreBackupDB.authenticate();
